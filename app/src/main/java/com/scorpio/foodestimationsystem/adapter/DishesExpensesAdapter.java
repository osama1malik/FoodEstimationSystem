...
public class DishesExpensesAdapter extends RecyclerView.Adapter<DishesExpensesAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<Dishes> list;
    private IngredientClickListener listener;

    public DishesExpensesAdapter(ArrayList<Dishes> list, IngredientClickListener listener) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        try {
            holder.quantity.setText(ExpensesFragment.quantityList.get(position) + "");
        } catch (Exception e) {
